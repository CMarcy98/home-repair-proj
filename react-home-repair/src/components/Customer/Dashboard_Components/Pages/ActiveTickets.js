...
export default class ActiveTickets extends Component {
	...
	componentWillMount() {
		...
		axios.get(`http://localhost:8000/tickets?userId=${userId}&status=0`)
			.then(res => {
	...
	render() {
		...
		return (
			<div>
				<h2 style={{ marginTop: 0, fontWeight: '100', backgroundColor: 'white', padding: '18px 0 18px 5%' }}>Active Tickets</h2>
